...
---
[:github: Github](https://mintlify.com/docs/api-playground/openapi/setup)
[:github: Releases](https://mintlify.com/docs/api-playground/openapi/setup)
<Step icon="your-icon" iconType="solid">
Your text here.
</Step>
## Configuration
    ### Add images
